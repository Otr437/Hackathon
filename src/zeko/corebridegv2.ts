// ============================================================================
// X402 CORE BRIDGE CONTRACT - DECEMBER 2025 PRODUCTION
// ============================================================================
// Component 1 of 8 - STANDALONE MODULE
// o1js v2.5.0+ | Mesa Upgrade Ready | Production Hardened
// ============================================================================
...
export class EmergencyPauseEvent extends Struct({
  pausedBy: PublicKey,
  reason: Field,
  timestamp: UInt64,
}) {}

export class ProtocolFeeUpdateEvent extends Struct({
  oldFeeBps: UInt32,
  newFeeBps: UInt32,
  updatedBy: PublicKey,
  timestamp: UInt64,
...
export class OwnershipTransferEvent extends Struct({
